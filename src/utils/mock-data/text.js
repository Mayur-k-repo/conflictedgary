...
export const description = [
  'It depends on the facts and the law but prob too late. ',
  'Security (no)',
  ' “The answer is ZERO” -Tom Emmer',
  '3880',
  'If Gary agrees to wear them too',
  'You would not want me to pre-judge, but prob no.',
  'Barring any wells notices, yea maybe.'

];

export const questions = [
  'What is the mint date?',
  'Which blockchain are the Garys on?',
  'What is the mint price?',
  'What is the total supply?',
  'Will there be Merch?',
  'Is there any Roadmap/Utilities?',
  'Upcoming projects?'
]
